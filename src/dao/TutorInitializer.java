...
public class TutorInitializer {
    ...
    public void initializeTutorList() {
        ...
        tutorList.add(new Tutor("T001", "Alice", 'F', "921202011466", "010-3456781", "alice@gmail.com", 2500.00, "Diploma", domainList1));
        ...
        tutorList.add(new Tutor("T005", "Eve", 'F', "930601011388", "012-3456785", "eve@gmail.com", 4400.00, "Master's Degree", domainList1));
        tutorList.add(new Tutor("T006", "Frank", 'M', "810402015635", "013-3456786", "frank@gmail.com", 4800.00, "Master's Degree", domainList3));
        ...
        tutorList.add(new Tutor("T010", "Jack", 'M', "990610017685", "012-3456790", "jack@gmail.com", 4200.00, "Diploma", domainList1));
        tutorList.add(new Tutor("T011", "Kate", 'F', "830221015382", "019-3456791", "kate@gmail.com", 4900.00, "phD", domainList2));
        ...
        tutorList.add(new Tutor("T014", "Noah", 'M', "930616017689", "012-3456794", "noah@gmail.com", 3800.00, "Diploma", domainList3));
        ...
        tutorList.add(new Tutor("T018", "Ryan", 'M', "921102044227", "015-3456798", "ryan@gmail.com", 3800.00, "Master's Degree", domainList2));
        tutorList.add(new Tutor("T019", "Sophia", 'F', "930816011234", "012-3456799", "sophia@gmail.com", 4100.00, "phD", domainList1));
        tutorList.add(new Tutor("T020", "Tyler", 'M', "980602037687", "016-3456800", "tyler@gmail.com", 3000.00, "Diploma", domainList3));
